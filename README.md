...
```bash 
$ find . -type f -name requirements.txt | xargs -n1 -I{} cat {} | cut -d '=' -f 1 | tr -d '>' | tr -d '~' | sort -u | awk '{print $1;}' |  xargs -n1 -I{} echo "https://pypi.org/project/{}/" | httpx -status-code -silent -content-length -mc 404
```
